...
function Dashboard() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col">
      <div className="sticky z-[1000] top-0 flex h-16 items-center gap-4 border-b bg-background px-4 md:px-6">
      ...
      {currentUser && <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
